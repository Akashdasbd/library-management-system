                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="appointment-list.html"><i class="fe fe-layout"></i> <span>Borrowing</span></a>
							</li>
							<li> 
								<a href="specialities.html"><i class="fe fe-users"></i> <span>Reservation</span></a>
							</li>
							<li class="submenu">
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-table"></i> <span> Books </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
